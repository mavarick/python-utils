...
def dist_range(ser, points):
    ...
    for p in ts:
        ...
        print >>sys.stdout, p, part_num, total_size, part_sum, total_sum, ratio_p, ratio_sum
    ...
    print >>sys.stdout, (points[-1],), part_num, total_size, part_sum, total_sum, ratio_p, ratio_sum
